                ...
                <div class="col-sm-12">
                    <div class="custom_menu">
                        <ul>
                            <li><a href="#"></a></li>
                            <li><a href=""></a></li>
                            <li><a href="{{ route('newrelease') }}"></a></li>
                            <li><a href="{{ route('todaysdeal') }}"></a></li>
                            <li><a href="{{ route('customerservice') }}"></a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="header_section">
        <div class="container">
            <div class="containt_main">
                ...
                <div class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Filtrer par Sous-Catégories
                    </button>
                    ...
                    <div class="login_menu">
                        <ul>
                            ...
                            <li><a href="{{ route('register') }}">
                                    <i class="fa fa-shopping-cart" aria-hidden="true"></i>
                                    <span class="padding_10">S'enregister</span></a>
                            </li>
                            @else
...
<div class="footer_section layout_padding">
    <div class="container">
        ...
        <div class="input_bt">
            ...
            <span class="subscribe_bt" id="basic-addon2"><a href="#">Newsletter</a></span>
        </div>
        ...
        <div class="location_main">Numéro de support : <a href="#">+33 06 78 90 11 12</a></div>
    </div>
</div>
<!-- footer section end -->
